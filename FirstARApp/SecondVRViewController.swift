//
//  SecondVRViewController.swift
//  Real-World Geometry
//
//  Created by Kyle Wang on 12/9/20.
//
...
class SecondVRViewController: UIViewController, ARSCNViewDelegate  {
...
//    }
        ...
        func renderer(_ renderer: SCNSceneRenderer, didAdd node: SCNNode, for anchor: ARAnchor) {
            ...
            let sphereNode = SCNNode(geometry: SCNBox(width: 0.2, height:0.0, length: 0.4, chamferRadius: 0))
        ...
        func processDetections(for request: VNRequest, error: Error?) {
            ...
            for observation in results where observation is VNRecognizedObjectObservation {
                guard let objectObservation = observation as? VNRecognizedObjectObservation,
                    ...
                    topLabelObservation.identifier == "keyboard" || topLabelObservation.identifier == "book",
